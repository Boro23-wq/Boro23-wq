...
I’m a Computer Science graduate. I’m currently working with `Typescript`, `Next.js`, and `NestJS` predominantly. Additionally, I also ```blog``` during my free time. I write about ```front-end```, ```development``` and ```best practices``` at large. I build `UI/UX` concept designs as well. I use `Figma` for the mockups and wireframes.
